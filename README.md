...
A small Flask app with web GUI that lets users download a handwriting template, fill it in,
upload it, and receive a custom TTF font generated by the `handwrite` package.

---

> **Made with AI** using pip module [handwrite](https://github.com/yashlamba/handwrite). Made for a friend.
## Project Structure
...
├── app.py
├── requirements.txt
├── template.png          ← ATTACHED (see below)
